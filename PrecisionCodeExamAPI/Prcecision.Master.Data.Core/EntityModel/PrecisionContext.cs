...
public partial class PrecisionContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<LeaveRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.ReportingTo).WithMany(p => p.LeaveRequestReportingTos)
                .HasForeignKey(d => d.ReportingToId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LeaveRequest_Users1");

            entity.HasOne(d => d.Requestor).WithMany(p => p.LeaveRequestRequestors)
                .HasForeignKey(d => d.RequestorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LeaveRequest_Users");
        });
